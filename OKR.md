...
- OKR是結構化的目標設定系統
  ...
  - 目標和關鍵結果，不是隨意的結合，而是具有嚴謹邏輯關係的構成
      ...
      - OKR的協同，是從上至下、從下至上、橫向之間的360度協同。
          - 提示
              - 無論哪個層級設定OKR時，都需要對準公司OKR。要多問問，對於公司OKR，自己能做那些貢獻。
              - OKR不應該是由上級幫助自己制定的，而是由責任者制定的，尤其是關鍵結果。
              - 在制定OKR時，我們要進行360度檢查，確保對齊協同。
      ...
      - OKR是敏捷工作法
          ...
          - 提示
              - 敏捷型組織通常會選用OKR進行目標管理。
              - OKR非常適用組織建立敏捷文化，實現敏捷組織轉型，它們具有相同的基因，相互促進，相互加強。
          - OKR是一種成長型思維
...
- OKR與KPI最大和最根本的區別，在於其實質和管理思維是不同的。
  ...
  - OKR的“關鍵”與KPI的“關鍵”，其實說的不是一個意思。KPI是要求我們將重要的指標選擇出來。而OKR是要求我們將一定時間內最優先的要求明確出來，將完成目標最重要的瓶頸選擇出來。
  - OKR與KPI並不是截然對立的。
    - KPI是OKR的來源。KPI能反映一個組織、團隊和個人成功的關鍵指標，所以KPI必然會成為OKR的來源。
    - 但KPI不等於OKR，因為OKR更聚焦，只會選擇那些需要更加投入、更優先的指標。
